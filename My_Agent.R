...
# The strategy we have chosen is called "spiteful_cc"" which was introduced and analyzed in the paper of Mathieu and Delahaye (2017). 
# Basically, our agent will cooperate for the first 2 rounds and then continue cooperating until an opponent defects. 
# From that moment onwards, our agent will always defect. 
